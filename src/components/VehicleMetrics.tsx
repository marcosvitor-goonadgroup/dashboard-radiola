...
const SocialIcon = ({ name }: { name: string }) => {
  const icons: { [key: string]: JSX.Element } = {
    ...
    'Google Ads': (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
        <path d="M8.1 2.6 1.4 14.2a3.35 3.35 0 0 0 5.8 3.35L13.9 6a3.35 3.35 0 1 0-5.8-3.4z"/>
        <path d="M22.6 14.2 15.9 2.6a3.35 3.35 0 0 0-5.8 3.35l6.7 11.6a3.35 3.35 0 0 0 5.8-3.35z"/>
        <circle cx="4.75" cy="19.65" r="3.35"/>
      </svg>
    ),
    'Programática': (
      <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
